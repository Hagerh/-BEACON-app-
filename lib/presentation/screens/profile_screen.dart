...
Widget _buildUserInfoCard(GlobalKey<FormState> formKey) {
  return Card(
          ...
          child: Column(
            ...
            children: [
                ...
                ElevatedButton(
                  ...
                  child: const Text('Save Changes', style: TextStyle(fontSize: 16, color: AppColors.primaryBackground), ),
                ),
            ]
          ),
        ),
